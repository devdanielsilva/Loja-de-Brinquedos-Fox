...
<body>
            ...
            <div class="col feature-box">
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li><a class="dropdown-item" href="../carrinho">Meus Pedidos</a></li>
                    </ul>
                </li>
            </div>
            <div class="col feature-box">
    ...
    <main>
        <nav class="nav1">
            <ul class="nav-ul">
                <li class="nav-item navbar-itens">
                    <a class="nav-link" href="../lista"><strong>Produtos</strong></a>
                </li>
                <li class="nav-item navbar-itens">
                    <a class="nav-link" href="#mais-vendidos"><strong>Mais Vendidos</strong></a>
                </li>
            </ul>
            </div>
            </div>
        ...
        <img class="home-img" src="http://res.cloudinary.com/dwmwpmrpo/image/upload/v1718145038/bbmpmdht1wbccn74lb22.jpg" alt="Aquarela Brinquedos">
                    ...
                    <div class="col-md-3">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div id="btn">
                                    <a href="{{ route('lista.show', $produto->PRODUTO_ID) }}" class="btn">Ver
                                        Detalhes</a>
                                </div>
                                <form method="POST" action="{{ route('carrinho.adicionar') }}">
                                    ...
                                    <div id="btn">
                                        <button type="submit" class="btn">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="40" height="28" fill="currentColor" class="bi bi-cart-plus me-2" viewBox="0 0 16 16">
