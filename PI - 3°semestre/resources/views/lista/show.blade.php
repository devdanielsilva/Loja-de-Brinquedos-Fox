    ...
    <header>
        ...
        <div class="row row-width" id="header">
            <div class="col feature-box">
                <a href="../home">
                    <svg width="56" height="60" viewBox="0 0 822 866" fill="none" xmlns="http://www.w3.org/2000/svg"
            ...
            <div class="col feature-box">
                <svg class="float-left" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
            ...
            <div class="col feature-box">
                <a href="../carrinho">
                    <svg id="cart" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
    ...
    <main>
        <div class="container mt-4" id="container">
            <div class="card" id="produto">
                <div class="row">
                    <h1 class="titulo">{{ $produto->PRODUTO_NOME }}</h1>
                </div>
                <div class="row">
                ...
                <div class="row">
                    ...
                    <img src="{{ $imagem->IMAGEM_URL }}" alt="Imagem do Produto" class="img">
                    @endforeach
                </div>
            </div>
    </main>
